        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          ...
          <div className="max-w-[330px] w-full">
            <ul className="flex flex-col gap-3 text-dark">
              <li>
                <Image src={'/images/logo/sunrise-logo.webp'} className="mb-4"  width={280} height={36} alt="sunrise-logo"/>
              </li>
              ...
              <li className="flex gap-4.5 ">
                ...
                #402.B Somapura 1st Stage Industrial Area, Nelamangala Talik Banglore - 56211
              </li>
