  ...
  return (
    ...
    >
      <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
        {/* <!-- header top start --> */}
        <div
          className={`flex flex-col lg:flex-row gap-5 lg:items-center sm:justify-between ease-out duration-200 ${
          ...
          <div className="flex w-full lg:w-auto items-center gap-7.5">
            ...
            <div className="flex w-full lg:w-auto justify-between items-center gap-5">
              <div className="flex items-center gap-5">
                <a
                  href="https://api.whatsapp.com/send/?phone=+91 858 996 6642&text=Hi+Hiamps&type=phone_number&app_absent=0"
                ...
                >
                  ...
                  >
                    <path
                      d="M20.52 3.48C18.24 1.2 15.24 0 12 0C5.37 0 0 5.37 0 12C0 13.98 0.48 15.87 1.38 17.52L0 24L6.63 22.65C8.25 23.52 10.08 24 12 24C18.63 24 24 18.63 24 12C24 8.76 22.8 5.76 20.52 3.48ZM12 21.6C10.32 21.6 8.73 21.15 7.38 20.34L7.11 20.19L3.57 21L4.38 17.49L4.2 17.19C3.36 15.75 2.91 13.95 2.91 12C2.91 6.9 6.9 2.91 12 2.91C14.52 2.91 16.86 3.9 18.57 5.61C20.28 7.32 21.3 9.63 21.3 12.15C21.3 17.25 17.25 21.6 12 21.6Z"
                      fill="#25D366"
                    />
                    <path
                      d="M17.1 14.22C16.83 14.1 15.63 13.53 15.39 13.44C15.15 13.35 14.97 13.31 14.79 13.58C14.61 13.85 14.07 14.44 13.92 14.61C13.77 14.78 13.62 14.79 13.35 14.67C13.08 14.55 12.21 14.26 11.19 13.38C10.41 12.72 9.84 11.85 9.69 11.58C9.54 11.31 9.67 11.16 9.79 11.04C9.9 10.92 10.05 10.71 10.17 10.53C10.29 10.35 10.35 10.23 10.44 10.05C10.53 9.87 10.5 9.72 10.44 9.6C10.38 9.48 9.93 8.37 9.72 7.89C9.51 7.41 9.3 7.47 9.12 7.47C8.94 7.47 8.76 7.46 8.58 7.46C8.4 7.46 8.13 7.52 7.89 7.77C7.65 8.02 7.05 8.58 7.05 9.72C7.05 10.86 7.89 12.09 9.06 13.35C10.23 14.61 11.91 15.75 13.65 16.41C14.1 16.58 14.52 16.72 14.91 16.84C15.51 17.03 16.02 16.99 16.43 16.94C16.91 16.88 17.82 16.37 18.03 15.78C18.24 15.19 18.24 14.64 18.18 14.52C18.12 14.4 17.94 14.34 17.67 14.22H17.1Z"
                      fill="#25D366"
                    />
                  </svg>
              ...
              <div>
              <a href="/contact" className="hidden md:inline-flex justify-center py-3 px-7 text-white bg-red-dark font-medium rounded-md ease-out duration-200 hover:bg-red">Contact Us</a>
            </div>
